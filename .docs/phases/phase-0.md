...
| 3 | Layout админки (admin) на теме Fastkart | ✅ Завершена |
| 4 | Авторизация: регистрация, вход, выход | ✅ Завершена |
| 5 | Гейт ролей + пустая витрина, дашборд-заглушка, 403 | ✅ Завершена |
